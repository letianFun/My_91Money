...
public class OSSUtil {
    private String endpoint = "oss-cn-huhehaote.aliyuncs.com";
    private String accessKeyId = "LTAIpwwfPuHPTCY6";
    private String accessKeySecret = "OYX5dZG1UFIu87zmNQcC11XEHEY0pn";
    private String bucketName = "letian-yifan";
